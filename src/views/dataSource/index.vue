  ...
  <div class="page">
    <div class="dataScreen" ref="dataScreenRef">
      <div class="dataScreen-header">
        <div class="dataScreen-header--title"></div>
        <div class="dataScreen-header--tabs">
          <div class="date"></div>
          <div class="tabs"></div>
        </div>
      </div>
...
import CareServe from './careServe/index.vue';
import Points from './points/index.vue';
import ProvertyWatch from './povertyWatch/index.vue';
